...
$sql = "SELECT * FROM tubuan2 WHERE id = $user_id"; // Assuming your table name is 'users'
          ...
          <tr>
            ...
            <td>
                <div class="input-group">
                    <span id="displayPassword" class="form-control"><?php echo str_repeat('*', strlen($password)); ?></span>
      ...
      <div class="modal-body">
        <form method="post" action="updateprofile.php">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="firstName" name="middle_name" value="<?php echo $middle_name; ?>">
          </div>
          <div class="form-group">
