...
if (isset($_POST['add_data'])) {
    ...
    $query = "INSERT INTO brgy_clearance (`id`, `full_name`, `address`, `date_of_birth`, `sex`, `civil_status`, `nationality`, `purpose`, `ctc_no`, `date_filed`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "UPDATE brgy_clearance SET full_name = ?, address = ?, date_of_birth = ?, sex = ?, civil_status = ?, nationality = ?, purpose = ?, ctc_no = ?, date_filed = ? WHERE id = ?";
    $stmt = mysqli_prepare($conn, $query);
...
if (isset($_GET['id'])) {
    ...
    $query = "DELETE FROM `brgy_clearance` WHERE `id` = '$userid'";
