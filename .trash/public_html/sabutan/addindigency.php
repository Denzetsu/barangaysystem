...
if (isset($_POST['add_data'])) {
    ...
    $query = "INSERT INTO certindigency (`full_name`, `age`, `date_filed`, `civil_status`, `purpose`) VALUES (?, ?, ?, ?, ?)";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "UPDATE certindigency SET full_name = ?, age = ?, purpose = ?, civil_status = ?, date_filed = ? WHERE id = ?";
    $stmt = mysqli_prepare($conn, $query);
...
if (isset($_GET['id'])) {
    ...
    $query = "DELETE FROM `certindigency` WHERE `id` = '$userid'";
