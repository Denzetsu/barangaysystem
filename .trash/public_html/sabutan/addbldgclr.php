...
if (isset($_POST['add_data'])) {
    ...
    $query = "INSERT INTO building_clearance (`name`, `purpose`, `location`, `date_filed`) VALUES (?, ?, ?, ?)";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "UPDATE building_clearance SET name = ?, purpose = ?, location = ?, date_filed = ? WHERE id = ?";
    $stmt = mysqli_prepare($conn, $query);
...
if (isset($_GET['id'])) {
    ...
    $query = "DELETE FROM `building_clearance` WHERE `id` = '$userid'";
