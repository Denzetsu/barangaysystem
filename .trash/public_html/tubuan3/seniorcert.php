  ...
  <div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
      ...
      <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
        <h1 class="m-0 font-weight-bold text-primary">Generate Senior Certification</h1>
          ...
          <div class="col-md-6">
            ...
            <div class="form-group">
              ...
              <div>
                ...
                <br>
                <a href="viewsenior.php" class="btn btn-danger add-btn">
                  <span class="btn-wrap">
    ...
    <script>
      ...
      function generateCertificate() {
        ...
        $("form").on("submit", function (event) {
          ...
          var _el = $('<div>')
          _el.append(_h)
          _el.append("<img src='img/seniorcert.png' height='auto' width='100%' style='position: absolute;'>");
