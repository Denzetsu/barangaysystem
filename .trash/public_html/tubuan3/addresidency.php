...
if (isset($_POST['add_data'])) {
    ...
    $query = "INSERT INTO certresidency1 (`id`, `name`, `date_filed`) VALUES (?, ?, ?)";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "UPDATE certresidency1 SET name = ?, date_filed = ? WHERE id = ?";
    $stmt = mysqli_prepare($conn, $query);
...
if (isset($_GET['id'])) {
    ...
    $query = "DELETE FROM `certresidency1` WHERE `id` = '$userid'";
