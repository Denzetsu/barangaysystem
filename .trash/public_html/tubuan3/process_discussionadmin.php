...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST['postContent']) && !empty($_POST['postContent'])) {
        ...
        // Insert the new post into the discussion_posts_admin1 table
        $insertQuery = "INSERT INTO discussion_posts_admin1 (post_content, post_date) VALUES ('$postContent', NOW())";
