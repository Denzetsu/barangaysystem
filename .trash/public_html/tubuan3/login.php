...
if (isset($_POST['login'])) {
    ...
    if ($result_tubuan1->num_rows == 1) {
        ...
        $sql_check_email = "SELECT * FROM (SELECT * FROM tubuan1 UNION SELECT * FROM tubuan1 UNION SELECT * FROM tubuan2) AS all_users WHERE email = '$email'";
...
<body>
  ...
  <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    <div class="logo-container">
      <img src="img/tubuan1logo.png" alt="Logo" width="200"> <!-- Adjust path to your logo -->
    </div>
  </nav>
  <!-- End of Topbar -->
  <body>
