...
if (isset($_POST['savedata'])) {
    ...
    $query = "INSERT INTO sabutan (`first_name`, `last_name`, `middle_name`, `suffix_name`, `gender`, `date_of_birth`, `birth_place`, `occupation`, `voter_status`, `barangay`, `email`, `password`, `family_head`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
...
$query = "DELETE FROM `sabutan` WHERE `id` = '$id'";
