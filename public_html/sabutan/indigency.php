        ...
        <form method="POST" class="row" id="certificateForm" autocomplete="off">
          ...
          <div class="col-md-6">
            ...
            <label class="col-form-label"><b>Civil Status:</b></label>
              ...
              <div>
                <input type="text" class="form-control" name="cDateOfIssue" id="cDateOfIssue" value="" >
              </div>
    ...
    <script>
      ...
      function generateCertificate() {
        ...
        $("form").on("submit", function (event) {
          ...
          var _el = $('<div>')
          _el.append(_h)
          _el.append("<img src='img/NewIndigency1.png' height='auto' width='100%' style='position: absolute;'>");
