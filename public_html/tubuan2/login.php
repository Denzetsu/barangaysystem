...
if (isset($_POST['login'])) {
    ...
    if ($result_tubuan2->num_rows == 1) {
        ...
        $sql_check_email = "SELECT * FROM (SELECT * FROM tubuan2 UNION SELECT * FROM tubuan2 UNION SELECT * FROM tubuan2) AS all_users WHERE email = '$email'";
