...
if (isset($_POST['add_data'])) {
    ...
    $query = "INSERT INTO officials2 (`Full_Name`, `Position`) VALUES (?, ?)";
...
if (isset($_GET['UserID'])) {
    ...
    $query = "DELETE FROM `officials2` WHERE `UserID` = '$userid'";
