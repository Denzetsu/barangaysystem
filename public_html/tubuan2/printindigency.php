...
<div style="display: none;">
  <div class="print_out_certificate">
    ...
    <div style="position: absolute; line-height: 0; margin: 790px 650px 0 150px; width: 1500px; font-family: 'Times New Roman', Times, serif;">
 
    <b> <label style="font-size: 45px; margin-left: 5px;" id="pStat">,</label></b>
    ...
    <div style="position: absolute; line-height: 0; margin: 1330px 650px 0 900px; width: 1050px; font-family: 'Times New Roman', Times, serif;">
    <b><label style="font-size: 45px;" id="pPurp"></b>
