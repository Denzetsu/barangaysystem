...
<div style="display: none;">
  <div class="print_out_certificate">
    ...
    <b><label style="font-size: 45px;" id="pPermit"></label></b> 
    </div>
   
    <div style="position: absolute; line-height: 0; margin:  1008px 200px 0 570px; width: 1500px; font-family: 'Times New Roman', Times, serif;">
    <b><label style="font-size: 45px; text-decoration: underline;" id="pBname"></label></b> 
    </div>
    <div style="position: absolute; line-height: 0; margin: 1065px 200px 0 570px; width: 1500px; font-family: 'Times New Roman', Times, serif;">
    <b><label style="font-size: 40px; text-decoration: underline;" id="pLoc"></label></b> 
    </div>
    <div style="position: absolute; line-height: 0; margin: 1125px 200px 0 570px; width: 1500px; font-family: 'Times New Roman', Times, serif;">
    <b><label style="font-size: 40px; text-decoration: underline;" id="pOwn"></label></b> 
    </div>
    <div style="position: absolute; line-height: 0; margin: 1179px 200px 0 570px; width: 1500px; font-family: 'Times New Roman', Times, serif;">
    <b><label style="font-size: 40px; text-decoration: underline;" id="pAdd"></label></b> 
    </div>
    ...
    <div style="position: absolute; line-height: 0; margin: 2000px 650px 0 910px; width: 1500px; font-family: 'Times New Roman', Times, serif;">
