...
if (isset($_POST['add_data'])) {
    ...
    $query = "INSERT INTO certindigency2 (`full_name`, `age`, `date_filed`, `civil_status`, `purpose`) VALUES (?, ?, ?, ?, ?)";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "UPDATE certindigency2 SET full_name = ?, age = ?, purpose = ?, civil_status = ?, date_filed = ? WHERE id = ?";
    $stmt = mysqli_prepare($conn, $query);
...
if (isset($_GET['id'])) {
    ...
    $query = "DELETE FROM `certindigency2` WHERE `id` = '$userid'";
