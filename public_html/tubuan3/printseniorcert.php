...
<div style="display: none;">
  <div class="print_out_certificate">
   ...
   <div style="position: absolute; line-height: 0; margin: 1830px 650px 0 665px; width: 1500px; font-family: 'Times New Roman', Times, serif;">
      <b style="font-size: 50px;"><?php echo $fullName; ?></b>  
    </div>
