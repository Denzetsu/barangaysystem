...
<div id="content">
    ...
    <h1 class="m-0 font-weight-bold text-primary">Apply for Senior ID</h1>
    ...
    if (isset($_SESSION['message']) && $_SESSION['message'] != '') {
     ...
     ?>
    <form method="POST" action="submitsenior.php" class="row" id="certificateForm" autocomplete="on">
    <div class="col-md-6">
        <div class="form-group">
            <label class="col-form-label"><b>Full Name:</b></label>
            <div>
            <input type="text" class="form-control" name="cFName" id="cFName" value="<?php echo $first_name . ' ' . $last_name; ?>" readonly required> 
            </div>
