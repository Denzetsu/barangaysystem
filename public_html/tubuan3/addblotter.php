...
if (isset($_POST['add_data'])) {
    ...
    $query = "INSERT INTO blotter_3 (`date_filed`, `respondent_name`, `complainant_name`, `subject`, `status`) VALUES (?, ?, ?, ?, ?)";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "UPDATE blotter_3 SET respondent_name = ?, complainant_name = ?, subject = ?, date_filed = ?, status = ? WHERE id = ?";
    $stmt = mysqli_prepare($conn, $query);
...
if (isset($_GET['id'])) {
    ...
    $query = "DELETE FROM `blotter_3` WHERE `id` = '$userid'";
