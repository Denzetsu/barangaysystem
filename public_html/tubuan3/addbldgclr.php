...
if (isset($_POST['add_data'])) {
    ...
    $query = "INSERT INTO building_clearance3 (`name`, `purpose`, `location`, `date_filed`) VALUES (?, ?, ?, ?)";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "UPDATE building_clearance3 SET name = ?, purpose = ?, location = ?, date_filed = ? WHERE id = ?";
    $stmt = mysqli_prepare($conn, $query);
...
if (isset($_GET['id'])) {
    ...
    $query = "DELETE FROM `building_clearance3` WHERE `id` = '$userid'";
