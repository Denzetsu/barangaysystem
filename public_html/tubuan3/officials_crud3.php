...
if (isset($_POST['add_data'])) {
    ...
    $query = "INSERT INTO officials3 (`Full_Name`, `Position`) VALUES (?, ?)";
...
if (isset($_GET['UserID'])) {
    ...
    $query = "DELETE FROM `officials3` WHERE `UserID` = '$userid'";
