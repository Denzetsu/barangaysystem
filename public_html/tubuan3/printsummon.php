...
function getFullNameByPosition($conn, $position) {
    $sql = "SELECT Full_Name FROM officials3 WHERE Position = '$position'";
...
<div style="display: none;">
  <div class="print_out_certificate">
    ...
    <div style="position: absolute; line-height: 0; margin: 1266px 650px 0 350px; width: 1500px; font-family: 'Times New Roman', Times, serif;">
    <b><label style="font-size: 40px;" id="pDay"></label></b> 
    </div>
    <div style="position: absolute; line-height: 0; margin: 1266px 650px 0 900px; width: 1500px; font-family: 'Times New Roman', Times, serif;">
    <b><label style="font-size: 40px;" id="pTime"></label></b> 
    </div>

    <div style="position: absolute; line-height: 0; margin: 1266px 650px 0 562px; width: 1500px; font-family: 'Times New Roman', Times, serif;">
    <b><label style="font-size: 40px;" id="pMny"></label></b> 
    </div>

    <div style="position: absolute; line-height: 0; margin: 1100px 700px 0 120px; width: 1500px; font-family: 'Times New Roman', Times, serif;">
    <b><label style="font-size: 40px; text-decoration: underline;" id="pTo"></label></b> 
    </div>
