...
if (isset($_POST['add_data'])) {
    ...
    $query = "INSERT INTO business_clearance3 (`id`, `name`, `location`, `owner`, `address`, `date_filed`) VALUES (?, ?, ?, ?, ?, ?)";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "UPDATE business_clearance3 SET name = ?, location = ?, owner = ?, address = ?, date_filed = ? WHERE id = ?";
    $stmt = mysqli_prepare($conn, $query);
...
if (isset($_GET['id'])) {
    ...
    $query = "DELETE FROM `business_clearance3` WHERE `id` = '$userid'";
