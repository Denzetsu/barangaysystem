...
<div id="content">
    ...
    <div class="form-group">
        ...
        <input type="datetime-local" id="date_filed" name="date_filed" class="form-control" readonly>
    </div>
    </div>
</form>
</div>
...
<script>
// Autofill the date field with the current date and time in Hong Kong timezone
document.addEventListener('DOMContentLoaded', function() {
    var dateFiled = document.getElementById('date_filed');
    var hongKongTime = new Date().toLocaleString('en-US', { timeZone: 'Asia/Hong_Kong' });
    var date = new Date(hongKongTime);
    ...
    dateFiled.value = `${year}-${month}-${day}T${hours}:${minutes}`;
});
</script>
